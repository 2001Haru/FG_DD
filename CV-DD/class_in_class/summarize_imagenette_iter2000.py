...
def main():
    ...
    summary = {
        "protocol": (
            "ImageNette IPC10 ResNet18 Recovery iteration2000; official vs "
            "official-split controlled seed42; BS10 T20 epochs300"
        ),
        ...
        "iteration4000_references": {
            "official_mean": 61.33,
            "controlled_seed42_mean": 58.96,
            "note": (
                "Descriptive references only; the old official relabel did not "
                "fix the same global runtime seed."
            ),
        },
    }
