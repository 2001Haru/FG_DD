...
readonly RECOVERY_LR=0.1
readonly RECOVERY_R_BN=0.01
...
for teacher_seed in "${TEACHER_SEEDS_ARRAY[@]}"; do
    ...
    RECOVERY_ITERATIONS="$RECOVERY_ITERATIONS" RECOVERY_LR="$RECOVERY_LR" \
    RECOVERY_R_BN="$RECOVERY_R_BN" VIEW_SEED=42 TEMPERATURE=20 \
